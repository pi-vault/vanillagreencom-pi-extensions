...
**Detect team context**: `.agents/skills/linear-orch/scripts/workflow-state exists [ISSUE_ID] && TEAM=$(.agents/skills/linear-orch/scripts/workflow-state get [ISSUE_ID] .team_name)`
...
| Next | Run `linear-orch ci-fix [PR_NUMBER]` again |
</output_format>

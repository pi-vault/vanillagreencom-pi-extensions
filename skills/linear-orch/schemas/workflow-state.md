...
Persistent state file for linear-orch workflows. Initialized during session start and designed to survive context compaction.
...
All operations use `.agents/skills/linear-orch/scripts/workflow-state`. Run `.agents/skills/linear-orch/scripts/workflow-state help` for full usage.

```bash
.agents/skills/linear-orch/scripts/workflow-state init PROJ-123 --agent backend --worktree /tmp/wt
.agents/skills/linear-orch/scripts/workflow-state get PROJ-123 .cycles
.agents/skills/linear-orch/scripts/workflow-state increment PROJ-123 cycles
.agents/skills/linear-orch/scripts/workflow-state append PROJ-123 json_paths "review.json"
.agents/skills/linear-orch/scripts/workflow-state set PROJ-123 pr_review_baseline '{"last_ts":"2026-01-28","last_threads":2}'
```
